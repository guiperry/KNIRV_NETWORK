...
scrape_configs:
  ...
  - job_name: 'knirv-testnet-chain'
    static_configs:
      - targets: ['host.docker.internal:8080']
    metrics_path: '/metrics'
    scrape_interval: 30s

  - job_name: 'knirv-testnet-graph'
    static_configs:
      - targets: ['host.docker.internal:8081']
    metrics_path: '/metrics'
    scrape_interval: 30s

  - job_name: 'knirv-testnet-nexus'
    static_configs:
      - targets: ['host.docker.internal:8082']
    metrics_path: '/metrics'
    scrape_interval: 30s

  - job_name: 'knirv-testnet-router'
    static_configs:
      - targets: ['host.docker.internal:5001']
    metrics_path: '/metrics'
    scrape_interval: 30s
...
networks:
  testnet:
    ...
    description: "Main KNIRV testnet network"
    services:
      - name: "ipfs"
