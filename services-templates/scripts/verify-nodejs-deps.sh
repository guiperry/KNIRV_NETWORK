...
AXIOS_FILE="$_DIR/internal/embedded/nodejs/tunnel/agent-tunnel-registry/node_modules/axios/dist/node/axios.cjs"
echo ""
...
PSL_FILE="$_DIR/internal/embedded/nodejs/payment/agent-payment-gateway/node_modules/psl/dist/psl.cjs"
echo ""
...
cd "$_DIR/internal/embedded/nodejs/tunnel/agent-tunnel-registry"
...
cd "$_DIR/internal/embedded/nodejs/payment/agent-payment-gateway"
