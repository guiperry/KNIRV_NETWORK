...
async function processReadme() {
  ...
  try {
    ...
    const indexContent = `# KNIRVORACLE Documentation\n\n${extractedContent}\n\n## Documentation Sections\n\n`;
    ...
    if (dir !== 'index.md' && typeof content === 'object') {
      ...
      switch (dir) {
        case 'getting-started':
          indexContent += 'This section helps you get up and running with KNIRVORACLE quickly.\n\n';
          break;
        case 'core-concepts':
          indexContent += 'Learn about the fundamental concepts that power KNIRVORACLE.\n\n';
          break;
        case 'protocols':
          indexContent += 'Detailed documentation of the protocols used in KNIRVORACLE.\n\n';
          break;
        case 'api-reference':
          indexContent += 'Complete reference for all KNIRVORACLE APIs.\n\n';
          break;
        case 'components':
          indexContent += 'Information about the various components that make up the KNIRVORACLE ecosystem.\n\n';
          break;
        case 'guides':
          indexContent += 'Step-by-step guides for common KNIRVORACLE tasks.\n\n';
          break;
        case 'troubleshooting':
          indexContent += 'Solutions to common problems and troubleshooting tips.\n\n';
          break;
        case 'sdk':
          indexContent += 'Documentation for the KNIRVORACLE SDK.\n\n';
          break;
      }
...
async function createSidebar() {
  ...
  let sidebarContent = '# KNIRVORACLE Docs\n\n';
...
async function cleanTargetDirectory() {
  ...
  if (fs.existsSync(sidebarPath)) {
    await writeFile(sidebarPath, '# KNIRVORACLE Docs\n\n');
  }
