...
// registerAllComponents registers all KNIRVORACLE components with the unified manager
...
// GetMainConfig returns the main KNIRVORACLE configuration
...
func (i *UnifiedConfigIntegration) PrintConfigurationSummary() {
	log.Println("=== KNIRVORACLE Unified Configuration Summary ===")
