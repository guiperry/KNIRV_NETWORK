...
func TestAgentManager_UpdateAgentRelationship(t *testing.T) {
	...
	updatedRelationship, err := agentManager.GetChromeManager().GetAgentRelationship(relationship.ID)
	if err != nil {
...
func TestAgentRelationshipStatusTransitions(t *testing.T) {
	...
	for _, newStatus := range statusTransitions {
		...
		updatedRel, err := agentManager.GetChromeManager().GetAgentRelationship(relationship.ID)
		if err != nil {
...
func TestAgentRelationshipConcurrency(t *testing.T) {
	...
	// Verify final state
	finalRel, err := agentManager.GetChromeManager().GetAgentRelationship(relationship.ID)
	if err != nil {
...
func TestAgentRelationshipPersistence(t *testing.T) {
	...
	newAgentManager := NewAgentManager(newChromemManager, nil, nil, nil)

	// Retrieve the relationship with the new manager
	retrievedRel, err := newAgentManager.GetChromeManager().GetAgentRelationship(originalID)
	if err != nil {
