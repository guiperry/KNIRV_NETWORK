...
export default function Features() {
  ...
  icon: <Bot className="h-8 w-8 knirv-text-primary" />,
    ...
    {
  icon: <Zap className="h-8 w-8 knirv-text-primary" />,
  ...
  icon: <Globe className="h-8 w-8 knirv-text-primary" />,
    ...
    {
  icon: <Settings className="h-8 w-8 knirv-text-primary" />,
      title: "Custom Configuration",
      description: "Tailor agent behavior with advanced configuration options and custom workflows.",
      badge: "Customization"
    },
    {
  icon: <Shield className="h-8 w-8 knirv-text-primary" />,
      title: "Enterprise Security",
      description: "Bank-level security with end-to-end encryption and compliance certifications.",
      badge: "Security"
    },
    {
  icon: <BarChart3 className="h-8 w-8 knirv-text-primary" />,
  ...
  <nav className="border-b border-white/10 bg-slate-900/50 backdrop-blur-lg">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/70 mb-12 max-w-3xl mx-auto leading-relaxed">
            Discover the comprehensive suite of features that make KNIRV the leading platform for AI agent integration.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Why Choose KNIRV?</h2>
          <div className="space-y-6">
            <div className="flex items-start space-x-4 p-6 bg-white/5 rounded-lg border border-white/10">
              ...
              <div className="flex items-start space-x-4 p-6 bg-white/5 rounded-lg border border-white/10">
              <Users className="h-6 w-6 knirv-text-primary mt-1 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-start space-x-4 p-6 bg-white/5 rounded-lg border border-white/10">
              <Cpu className="h-6 w-6 knirv-text-primary mt-1 flex-shrink-0" />
              <div>
