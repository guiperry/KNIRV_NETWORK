  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold text-white mb-4">Connect Your <span className="knirv-gradient-text">GitHub Repository</span></h2>
        <p className="text-xl text-white/70">
          Enter your GitHub repository URL and we'll analyze it to create the perfect KNIRV AI agent
        </p>
      </div>
        ...
        <Card className="knirv-card-gradient backdrop-blur-lg">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
              <Link className="h-5 w-5 mr-2 knirv-text-primary" />
              GitHub Repository URL
            </CardTitle>
            <CardDescription className="text-white/70">
              Paste the URL of the GitHub repository you want to transform with KNIRV
            </CardDescription>
          </CardHeader>
