            ...
            <section className="relative pt-40 pb-20 overflow-hidden" data-name="hero" data-file="components/Hero.js">
                ...
                <div className="container mx-auto px-6 relative z-10 max-w-5xl text-center">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                        The <span className="text-[var(--accent-blue)]">Unified</span><br /> KNIRV Syndicate.
                    </h1>
                    <p className="text-xl md:text-2xl text-[var(--text-gray)] mb-10 max-w-3xl mx-auto">
                        ...
                        One pipeline for security exploits and curated code errors, with deterministic backend pricing and on-chain risk pools.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a href={arenaURL} className="btn-primary flex items-center justify-center gap-2">
                            <div className="icon-swords"></div> Join the Syndicate
                        </a>
                        <a href="https://knirv.network/developer-portal/syndicate.html" className="btn-outline flex items-center justify-center gap-2">
