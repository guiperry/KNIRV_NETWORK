    ...
    <Layout>
      <div className="p-4 pb-24 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="text-center p-4 bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50">
            <div className="text-2xl font-bold text-purple-400">{totalNrnCost}</div>
        ...
        <div className="flex space-x-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-slate-800/80 backdrop-blur-xl rounded-xl border border-slate-700/50 focus:border-purple-500/50 focus:outline-none text-white placeholder-slate-400"
            />
          </div>
          <button className="px-4 py-3 bg-slate-800/80 backdrop-blur-xl rounded-xl border border-slate-700/50 hover:border-purple-500/50 text-slate-400 hover:text-purple-400 transition-all">
            <Filter className="w-4 h-4" />
          </button>
          <button className="px-4 py-3 bg-gradient-to-r from-purple-600/20 to-cyan-600/20 hover:from-purple-600/30 hover:to-cyan-600/30 rounded-xl border border-purple-500/30 text-purple-400 hover:text-purple-300 transition-all">
        ...
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600/30 to-cyan-600/30 rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
          <div className="relative bg-slate-800/60 backdrop-blur-xl rounded-xl p-6 border border-slate-700/50 hover:border-purple-500/50 transition-all text-center">
            ...
            <button className="px-6 py-2 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 rounded-lg text-white font-medium transition-all transform hover:scale-105">
              Browse Marketplace
            </button>
          </div>
        </div>
