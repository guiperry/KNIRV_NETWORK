...
pub fn main() {
    ...
    console_log!("Agent-Core WASM initialized: {}", "training-test-agent");
}
...
impl AgentCore {
    ...
    pub fn new() -> AgentCore {
        let config = AgentConfig {
            agent_id: "training-test-agent".to_string(),
    ...
    pub fn agent_core_get_status(&self) -> String {
        format!(
            r#"{{"agentId": "{}", "agentName": "Training Test Agent", "version": "1.0.0", "initialized": {}, "cognitiveEngine": "rust-wasm", "availableTools": [], "memorySize": {}}}"#,
