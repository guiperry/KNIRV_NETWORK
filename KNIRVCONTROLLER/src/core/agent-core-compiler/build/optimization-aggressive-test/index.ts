...
export const AGENT_CONFIG = {
  agentId: 'optimization-aggressive-test',
  agentName: 'Optimization aggressive Test',
  agentDescription: 'Test aggressive optimization',
  agentVersion: '1.0.0',
  author: 'test',
  buildTarget: 'wasm',
  factsUrl: '{{factsUrl}}',
  ...
  ttl: 3600,
  signature: 'mock-signature-1758040348738'
};
