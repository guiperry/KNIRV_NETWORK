...
build {
  sources = ["source.amazon-ebs.kali-server"]
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo mkdir -p /etc/knirv-server",
      "sudo mkdir -p /var/lib/knirv-server",
      "sudo mkdir -p /var/log/knirv-server",
      "sudo chmod 755 /etc/knirv-server",
      "sudo chmod 755 /var/lib/knirv-server",
      "sudo chmod 755 /var/log/knirv-server",
