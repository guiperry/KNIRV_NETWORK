...
// Note: Session and endpoint types are defined in dve.go
// SSHSession, ValidationSession, ErrorResolutionSession, TEEEndpoint, and Credentials
// are shared between DVE creation and rental contexts.
