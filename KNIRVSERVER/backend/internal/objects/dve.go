...
// DVEAccessInfo aggregates access information for a DVE
type DVEAccessInfo struct {
	ContainerInfo *ContainerInfo `json:"container_info"`
}

// ContainerInfo holds container-specific details
...
// AllocatedResources describes resource allocations
