...
const LocalDeploymentGuide = ({ agentName, platform: initialPlatform, onDownload, compiledPluginUrl, onPlatformChange }: LocalDeploymentGuideProps) => {
  ...
  const handleDownloadEngine = (platform: 'windows' | 'mac' | 'linux') => {
    if (platform === 'windows') {
      ...
      toast({
        ...
        description: "Starting download for Windows KNIRV Engine",
      });
  ...
  const handleMacDownload = (architecture: 'arm64' | 'amd64') => {
    ...
    toast({
      ...
      description: `Starting download for Mac ${architecture} KNIRV Engine`,
    });
  };
  ...
  const handleLinuxDownload = (architecture: 'arm64' | 'amd64') => {
    ...
    toast({
      ...
      description: `Starting download for Linux ${architecture} KNIRV Engine`,
    });
  };
  ...
  const platformConfig = {
    windows: {
      ...
      configPath: '%APPDATA%\\KNIRV-Engine\\config',
      pluginsPath: '%APPDATA%\\KNIRV-Engine\\plugins',
    ...
    mac: {
      ...
      configPath: '~/Library/Application Support/KNIRV-Engine/config',
      pluginsPath: '~/Library/Application Support/KNIRV-Engine/plugins',
  ...
  const steps = [
    {
      title: 'Download KNIRV Engine',
      description: 'Download the KNIRV Engine for your platform',
      icon: Download,
      content: (
          ...
          <div className="bg-white/10 rounded-lg p-4">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Download the KNIRV Engine runtime for your platform</p>
              </div>
            </div>
            <Button
  ...
  "logging": {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h5 className="text-white font-medium mb-2">Start the KNIRV Engine:</h5>
            <div className="bg-gray-900 rounded-lg p-3 font-mono text-sm">
              <div className="flex items-center justify-between">
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-white/70 mt-2">
          <span className="text-yellow-400">Note:</span> You'll need to download both the Agent Plugin and the KNIRV Engine separately.
        </p>
