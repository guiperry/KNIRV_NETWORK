0# KNIRVSERVER Governance Implementation Plan
...
**File:** `KNIRV_CORP/server/backend/internal/web/middleware/governance.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/identitybridge/revocation.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/policyadapter/rego.go`
...
**File:** `KNIRV_CORP/server/backend/internal/web/middleware/governance.go` (same file as Phase 1-B)
...
**File:** `KNIRV_CORP/server/backend/internal/services/guardrails/governance_bridge.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/reliability/dve_binding.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/reliability/escalation.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/reliability/slo.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/mcphardening/schema.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/mcphardening/injection.go`
...
**File:** `KNIRV_CORP/server/backend/internal/services/mcphardening/response.go`
...
**Package:** `KNIRV_CORP/server/backend/internal/services/compliance`
...
**File:** `KNIRV_CORP/server/backend/internal/web/compliance_handlers.go`
...
#### 7-B: Server — `KNIRV_CORP/server/backend/internal/services/governance_sdk/`
...
```go
// KNIRV_CORP/server/backend/internal/services/governance_sdk/server.go
