# KNIRVENGINE - Browser Bridge: A Decentralized Wallet for the KNIRV Ecosystem
...
**KNIRVENGINE - Browser Bridge** is a powerful, open-source, non-custodial wallet providing seamless access to the KNIRV Decentralized Trusted Execution Network (D-TEN).  It allows users to manage NRN tokens, control KNIRV-CORTEX agents, and interact with the KNIRV ecosystem via an intuitive, Web2-like experience powered by XION's Meta Accounts.  For users, it simplifies managing decentralized AI and crypto; for developers, it offers comprehensive APIs for ecosystem and KNIRV-CORTEX agent integration.  KNIRVENGINE - Browser Bridge supports browser extensions, mobile apps, and progressive web apps, all unified under a single interface.
...
- [KNIRVENGINE_Whitepaper](../docs/whitepapers/KNIRVENGINE_Whitepaper.md)
...
KNIRVENGINE - Browser Bridge is part of the broader KNIRV ecosystem:
...
Thank you for considering contributing to KNIRVENGINE - Browser Bridge! We value your input. Before submitting a pull request, please review these guidelines:
