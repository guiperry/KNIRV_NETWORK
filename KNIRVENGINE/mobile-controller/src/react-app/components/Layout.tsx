...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative">
      ...
      {/* Header */}
      <header className="relative z-10 border-b border-purple-500/20 backdrop-blur-xl bg-slate-900/50">
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="w-8 h-8 bg-gradient-to-br from-purple-400 to-cyan-400 rounded-lg shadow-lg shadow-purple-500/25"></div>
                <div className="absolute inset-0 bg-gradient-to-br from-purple-400 to-cyan-400 rounded-lg animate-pulse opacity-75"></div>
              </div>
              <div>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-20 border-t border-purple-500/20 backdrop-blur-xl bg-slate-900/80">
