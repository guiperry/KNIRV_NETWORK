...
func (m *MockAgentInferencer) GetActiveAgent() AgentPluginInterface {
...
func (m *MockAgentInferencer) ActivateAgent(agentID string) error {
...
func (m *MockAgentInferencer) ListAgents() []string {
...
func (m *MockAgentInferencer) ProcessInference(ctx context.Context, request *InferenceRequest) (*InferenceResponse, error) {
	activeAgent := m.GetActiveAgent()
	if activeAgent == nil {
		return nil, fmt.Errorf("no active agent")
	}
	return activeAgent.ProcessInference(ctx, request)
}
