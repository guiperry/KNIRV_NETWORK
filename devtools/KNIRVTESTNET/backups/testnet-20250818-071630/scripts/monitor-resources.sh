...
while true; do
    ...
    for service in knirvoracle knirvchain knirvgraph knirvserver knirvrouter; do
    ...
    for dir in data/knirvoracle data/knirvchain data/knirvgraph data/knirvserver data/ipfs; do
        if [ -d "$dir" ]; then
