...
class NexusHealthChecker {
    ...
    async checkNexusDirectory() {
        ...
        // In testnet environment, nexus-portal is in the knirvgateway data directory
        ...
        if (!fs.existsSync(nexusPath)) {
            this.log('nexus-portal directory does not exist in testnet environment', 'warn');
            this.warnings.push('nexus-portal directory missing - will create from production template');
            return false;
        }
