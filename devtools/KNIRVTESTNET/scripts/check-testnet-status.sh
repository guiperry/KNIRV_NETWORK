...
check_service "KNIRV-SERVER" "8084" "/health" "data/knirvserver.pid"
...
check_pid_file "KNIRV-SERVER" "data/knirvserver.pid"
...
echo "🔒 KNIRV-SERVER API: http://localhost:8084"
echo "🔒 KNIRV-SERVER GUI: http://localhost:8083"
