...
class TestHealth:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_check(self, client: KnirvchainTransactionSDK) -> None:
        health = client.health.check()
        assert_matches_type(HealthCheckResponse, health, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_check(self, client: KnirvchainTransactionSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_check(self, client: KnirvchainTransactionSDK) -> None:
...
class TestAsyncHealth:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_check(self, async_client: AsyncKnirvchainTransactionSDK) -> None:
        health = await async_client.health.check()
        assert_matches_type(HealthCheckResponse, health, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_check(self, async_client: AsyncKnirvchainTransactionSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncKnirvchainTransactionSDK) -> None:
