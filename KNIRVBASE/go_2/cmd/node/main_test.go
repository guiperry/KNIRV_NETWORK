...
func TestLoadConfig(t *testing.T) {
	...
	testEnv := map[string]string{
		"KNIRVCHAIN_NODE_ID":     "test-node",
		"KNIRVCHAIN_LISTEN_ADDR": "127.0.0.1:9999",
		"KNIRVCHAIN_DATA_DIR":    "/tmp/test-data",
		"KNIRVCHAIN_WALLET_KEY":  "test-key",
		"KNIRVCHAIN_NETWORK_URL": "https://test.network",
		"KNIRVCHAIN_CHAIN_ID":    "test-chain",
		"KNIRVCHAIN_LOG_LEVEL":   "debug",
	}
...
func TestLoadConfigDefaults(t *testing.T) {
	...
	envKeys := []string{
		"KNIRVCHAIN_NODE_ID",
		"KNIRVCHAIN_LISTEN_ADDR",
		"KNIRVCHAIN_DATA_DIR",
		"KNIRVCHAIN_WALLET_KEY",
		"KNIRVCHAIN_NETWORK_URL",
		"KNIRVCHAIN_CHAIN_ID",
		"KNIRVCHAIN_LOG_LEVEL",
	}
	...
	expected := &Config{
		NodeID:     "knirvchain-node-1",
		ListenAddr: "localhost:8080",
		DataDir:    filepath.Join(os.TempDir(), "knirvchain"),
		WalletKey:  "mock",
