# KNIRVCHAIN Tunnel Registry Service

This service provides NAT traversal, node registration, and URI resolution for the KNIRVCHAIN network.
...
- `RELAY_SERVER_PEER_ID`: PeerID of the KNIRVCHAIN-ROOT node
