...
# Script to run the KNIRVCHAIN Payment Processor

# Set default values
PORT=${PORT:-8090}
KNIRVCHAIN_NODE_RPC=${KNIRVCHAIN_NODE_RPC:-"http://127.0.0.1:5000"}
...
echo "Using KNIRVCHAIN node at $KNIRVCHAIN_NODE_RPC"
