...
def process_readme():
    ...
    try:
        ...
        index_content = f"# KNIRVCHAIN Documentation\n\n{''.join(extracted_content)}\n\n## Documentation Sections\n\n"
    ...
    for dir_name, content in STRUCTURE.items():
        if dir_name != 'index.md' and isinstance(content, dict):
            ...
            if dir_name == 'getting-started':
                index_content += 'This section helps you get up and running with KNIRVCHAIN quickly.\n\n'
            elif dir_name == 'core-concepts':
                index_content += 'Learn about the fundamental concepts that power KNIRVCHAIN.\n\n'
            elif dir_name == 'protocols':
                index_content += 'Detailed documentation of the protocols used in KNIRVCHAIN.\n\n'
            elif dir_name == 'api-reference':
                index_content += 'Complete reference for all KNIRVCHAIN APIs.\n\n'
            elif dir_name == 'components':
                index_content += 'Information about the various components that make up the KNIRVCHAIN ecosystem.\n\n'
            elif dir_name == 'guides':
                index_content += 'Step-by-step guides for common KNIRVCHAIN tasks.\n\n'
            elif dir_name == 'troubleshooting':
                index_content += 'Solutions to common problems and troubleshooting tips.\n\n'
            elif dir_name == 'sdk':
                index_content += 'Documentation for the KNIRVCHAIN SDK.\n\n'
...
def create_sidebar():
    ...
    sidebar_content = '# KNIRVCHAIN Docs\n\n'
