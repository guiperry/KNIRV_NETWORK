...
import (
	...
	"KNIRVCHAIN/dataengine"
	"KNIRVCHAIN/enum/StatusType"
	"KNIRVCHAIN/errors"
	"KNIRVCHAIN/inference"
	"KNIRVCHAIN/inference/agentify"
...
func main() {
	...
	if nodeRole != config.Root {
		...
		if cfg.MinersAddress == utils.BLOCKCHAIN_ADDRESS || cfg.MinersAddress == "KNIRVCHAIN_Faucet" {
