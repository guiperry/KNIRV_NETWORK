...
export default function DocumentationPage() {
  ...
  const quickLinks = [
    { title: 'Installation Guide', href: 'https://knirv.network/developer-portal/', icon: Download },
    { title: 'API Reference', href: 'https://knirv.network/developer-portal/', icon: Code },
    { title: 'Examples', href: 'https://knirv.network/developer-portal/', icon: FileText },
            ...
            <Card className="knirv-card-gradient backdrop-blur-lg">
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="https://knirv.network/developer-portal/" data-config-nav="documentation" className="text-blue-400 hover:text-blue-300 flex items-center">
