...
// ProcessGraphEvent processes a graph event
func (d *DataEngine) ProcessGraphEvent(nodeID string, eventType string, data map[string]interface{}) error {
	if data == nil {
		data = make(map[string]interface{})
	}
	data["node_id"] = nodeID
	data["event_id"] = fmt.Sprintf("graph-%d", time.Now().UnixNano())
...
// ProcessNRVEvent processes an NRV system event
func (d *DataEngine) ProcessNRVEvent(vectorID string, eventType string, data map[string]interface{}) error {
	if data == nil {
		data = make(map[string]interface{})
	}
	data["vector_id"] = vectorID
	data["event_id"] = fmt.Sprintf("nrv-%d", time.Now().UnixNano())
...
// ProcessSkillEvent processes a skill node event
func (d *DataEngine) ProcessSkillEvent(skillID string, eventType string, data map[string]interface{}) error {
	if data == nil {
		data = make(map[string]interface{})
	}
	data["skill_id"] = skillID
	data["event_id"] = fmt.Sprintf("skill-%d", time.Now().UnixNano())
