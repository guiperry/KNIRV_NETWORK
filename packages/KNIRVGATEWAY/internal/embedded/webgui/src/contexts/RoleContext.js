...
export const RoleProvider = ({ children }) => {
  ...
  const pageAccess = {
    Root: [
      ...
      'knirvchain', 'graph-explorer', 'chain-explorer', 'chain-explorer-new',
      'txchain', 'network-monitor', 'oracle-explorer',
      'valchain', 'graphchain-dashboard', 'graphchain-errors', 'graphchain-skills', 'error-explorer',
      'oracle', 'models', 'codex-builder', 'models-dex', 'bootnode-dao', 'network-inference-dao',
      ...
      'monitor', 'peers', 'operator-registry', 'tunnel-registry',
