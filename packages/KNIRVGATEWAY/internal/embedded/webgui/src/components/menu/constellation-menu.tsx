...
const innerLabels = [
  ...
  { label: "KNIRVIDE", angle: 250 },
  { label: "KNIRVCHAIN", angle: 290 },
  { label: "KNIRVGRAPH", angle: 330 },
  { label: "KNIRVARENA", angle: 10 },
  { label: "KNIRVAGENT", angle: 50 },
  { label: "KNIRVHASHER", angle: 90 },
  { label: "KNIRVBASE", angle: 130 },
  { label: "KNIRVWORKERS", angle: 170 },
]

const middleLabels = [
  { label: "KNIRVSERVER", angle: 230 },
  { label: "KNIRVSDK", angle: 270 },
  { label: "KNIRVMONITOR", angle: 310 },
  { label: "KNIRVCORTEX", angle: 350 },
  { label: "KNIRVGATEWAY", angle: 30 },
  { label: "KNIRVCONTROLLER", angle: 70 },
  { label: "KNIRVORACLE", angle: 110 },
  { label: "KNIRVBRIDGE", angle: 150 },
  { label: "KNIRVTESTNET", angle: 190 },
]

// href: null opens the local settings modal instead of navigating
const outerIcons = [
  { icon: Triangle, angle: 0,   href: "/dashboard",       label: "Setup" },
  { icon: Globe,    angle: 45,  href: "/dashboard",       label: "WebGUI" },
  { icon: User,     angle: 90,  href: "/network-admin",   label: "Admin" },
  { icon: Cpu,      angle: 135, href: "/models",          label: "Cognitive" },
  { icon: Layers,   angle: 180, href: "/dve-list",        label: "DVE Nodes" },
  { icon: Settings, angle: 225, href: null,               label: "Settings" },
  { icon: Eye,      angle: 270, href: "/network-monitor", label: "Reports" },
  { icon: Box,      angle: 315, href: "/my-badges",       label: "Badge Lab" },
]
...
export default function ConstellationMenu() {
  ...
  const handleIconClick = (href: string | null) => {
    if (href === null) {
