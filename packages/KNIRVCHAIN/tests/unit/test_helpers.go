...
// NewWalletServer removed: internal/wallet/wallet_server.go was deleted.
// KNIRVORACLE now owns wallet-server-equivalent HTTP endpoints
// (generate_wallet, balance, send_signed_txn, etc.) via internal/oracle/routes.
