...
pub fn main() {
    ...
    console_log!("Agent-Core WASM initialized: {}", "deployment-test-agent");
}
...
impl AgentCore {
    ...
    pub fn new() -> AgentCore {
        let config = AgentConfig {
            agent_id: "deployment-test-agent".to_string(),
    ...
    pub fn agent_core_get_status(&self) -> String {
        format!(
            r#"{{"agentId": "{}", "agentName": "Deployment Test Agent", "version": "1.0.0", "initialized": {}, "cognitiveEngine": "rust-wasm", "availableTools": [], "memorySize": {}}}"#,
