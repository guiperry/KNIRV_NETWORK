...
pub fn main() {
    ...
    console_log!("Agent-Core WASM initialized: {}", "e2e-test-agent");
}
...
impl AgentCore {
    ...
    pub fn new() -> AgentCore {
        let config = AgentConfig {
            agent_id: "e2e-test-agent".to_string(),
    ...
    pub fn agent_core_get_status(&self) -> String {
        format!(
            r#"{{"agentId": "{}", "agentName": "E2E Test Agent", "version": "1.0.0", "initialized": {}, "cognitiveEngine": "rust-wasm", "availableTools": [], "memorySize": {}}}"#,
