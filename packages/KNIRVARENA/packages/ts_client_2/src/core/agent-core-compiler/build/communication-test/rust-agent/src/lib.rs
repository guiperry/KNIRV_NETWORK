...
pub fn main() {
    ...
    console_log!("Agent-Core WASM initialized: {}", "communication-test");
}
...
impl AgentCore {
    ...
    pub fn new() -> AgentCore {
        let config = AgentConfig {
            agent_id: "communication-test".to_string(),
    ...
    pub fn agent_core_get_status(&self) -> String {
        format!(
            r#"{{"agentId": "{}", "agentName": "Communication Test", "version": "1.0.0", "initialized": {}, "cognitiveEngine": "rust-wasm", "availableTools": [], "memorySize": {}}}"#,
