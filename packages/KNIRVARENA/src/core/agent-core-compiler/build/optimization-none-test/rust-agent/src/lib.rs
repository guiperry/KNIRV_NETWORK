...
pub fn main() {
    ...
    console_log!("Agent-Core WASM initialized: {}", "optimization-none-test");
}
...
impl AgentCore {
    ...
    pub fn new() -> AgentCore {
        let config = AgentConfig {
            agent_id: "optimization-none-test".to_string(),
    ...
    pub fn agent_core_get_status(&self) -> String {
        format!(
            r#"{{"agentId": "{}", "agentName": "Optimization none Test", "version": "1.0.0", "initialized": {}, "cognitiveEngine": "rust-wasm", "availableTools": [], "memorySize": {}}}"#,
