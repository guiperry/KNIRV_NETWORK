...
pub fn main() {
    ...
    console_log!("Agent-Core WASM initialized: {}", "integration-test-agent");
}
...
impl AgentCore {
    ...
    pub fn agent_core_get_status(&self) -> String {
        format!(
            r#"{{"agentId": "{}", "agentName": "Integration Test Agent", "version": "1.0.0", "initialized": {}, "cognitiveEngine": "rust-wasm", "availableTools": [], "memorySize": {}}}"#,
