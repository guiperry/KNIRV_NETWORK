import fs from 'fs';
import type { ResponseLike } from 'knirvchain-transaction-sdk/internal/to-file';
import { toFile } from 'knirvchain-transaction-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('knirvchain-transaction-sdk/core/uploads');
    await expect(
