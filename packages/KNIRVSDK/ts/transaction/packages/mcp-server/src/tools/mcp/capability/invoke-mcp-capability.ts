...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/mcp/capability/invoke',
  operationId: 'mcpInvokeCapability',
};

export const tool: Tool = {
  name: 'invoke_mcp_capability',
  description:
...
export const handler = async (
  ...
  return asTextContentResult(await client.mcp.capability.invoke(body));
};
