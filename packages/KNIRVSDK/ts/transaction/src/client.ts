...
import {
  UriGenerator,
  UriGeneratorCreateParams,
  UriGeneratorCreateResponse,
} from './resources/uri-generator';
...
import {
  ContextRecord,
  Mcp,
  McpRetrieveCapabilitiesParams,
  McpRetrieveCapabilitiesResponse,
  McpRetrieveContextsParams,
...
export class KnirvchainTransactionSDK {
   ...
   */
  constructor({
    baseURL = readEnv('KNIRVCHAIN_TRANSACTION_SDK_BASE_URL'),
    apiKey = readEnv('KNIRVCHAIN_TRANSACTION_SDK_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.logLevel =
      ...
      parseLogLevel(
        readEnv('KNIRVCHAIN_TRANSACTION_SDK_LOG'),
        "process.env['KNIRVCHAIN_TRANSACTION_SDK_LOG']",
        this,
      ) ??
      defaultLogLevel;
  ...
  protected stringifyQuery(query: Record<string, unknown>): string {
    return Object.entries(query)
      ...
      .map(([key, value]) => {
        ...
        throw new Errors.KnirvchainTransactionSDKError(
  ...
  static KnirvchainTransactionSDK = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static KnirvchainTransactionSDKError = Errors.KnirvchainTransactionSDKError;
  ...
  chain: API.Chain = new API.Chain(this);
  block: API.BlockResource = new API.BlockResource(this);
  transaction: API.TransactionResource = new API.TransactionResource(this);
  txnPool: API.TxnPool = new API.TxnPool(this);
  info: API.Info = new API.Info(this);
  health: API.Health = new API.Health(this);
  ping: API.Ping = new API.Ping(this);
  peers: API.Peers = new API.Peers(this);
  uriGenerator: API.UriGenerator = new API.UriGenerator(this);
...
export declare namespace KnirvchainTransactionSDK {
  ...
  export {
    BlockResource as BlockResource,
    type Block as Block,
  ...
  export {
    TransactionResource as TransactionResource,
