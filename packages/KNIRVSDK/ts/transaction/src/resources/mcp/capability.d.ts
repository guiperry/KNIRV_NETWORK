...
export declare class Capability extends APIResource {
     ...
     */
    prepareRegistration(body: CapabilityPrepareRegistrationParams, options?: RequestOptions): APIPromise<CapabilityPrepareRegistrationResponse>;
    /**
     * Lists all invocations of a specific capability
     */
    retrieveInvocations(capabilityID: string, options?: RequestOptions): APIPromise<CapabilityRetrieveInvocationsResponse>;
}
...
export type CapabilityDescriptor = CapabilityDescriptor.ResourceDescriptor | CapabilityDescriptor.ToolDescriptor | CapabilityDescriptor.PromptDescriptor | CapabilityDescriptor.MemoryServiceDescriptor;
export declare namespace CapabilityDescriptor {
    interface ResourceDescriptor extends CapabilityAPI.BaseDescriptor {
        /**
         ...
         */
        resourceType?: 'FILE' | 'API' | 'PLUGIN' | 'GENERATED_DOCUMENT' | 'DATASET' | 'MODEL_ARTIFACT' | 'SERVICE';
    ...
    interface ToolDescriptor extends CapabilityAPI.BaseDescriptor {
        /**
    ...
    interface PromptDescriptor extends CapabilityAPI.BaseDescriptor {
        /**
    ...
    interface MemoryServiceDescriptor extends CapabilityAPI.BaseDescriptor {
        /**
...
export declare namespace CapabilityPrepareRegistrationResponse {
    /**
     * A structured representation of the unsigned transaction the client is expected
     * to form and sign.
     */
