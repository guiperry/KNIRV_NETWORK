...
export declare class APIPromise<T> extends Promise<T> {
    ...
    constructor(client: KnirvchainTransactionSDK, responsePromise: Promise<APIResponseProps>, parseResponse?: (client: KnirvchainTransactionSDK, props: APIResponseProps) => PromiseOrValue<T>);
