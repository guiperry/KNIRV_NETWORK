...
from knirvchain_transaction_sdk._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(sync: bool, client: KnirvchainTransactionSDK, async_client: AsyncKnirvchainTransactionSDK) -> None:
...
async def test_data_missing_event(
    sync: bool, client: KnirvchainTransactionSDK, async_client: AsyncKnirvchainTransactionSDK
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"
