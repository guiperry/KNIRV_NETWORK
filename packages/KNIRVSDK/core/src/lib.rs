...
pub use bindings::{
    BindingConfig, BindingEngine, BindingError, BindingErrorCode, RequestEnvelope,
...
pub use wasm_modules::{materialize_wasm_module, wasm_module, WasmModule, WasmModuleMetadata};
