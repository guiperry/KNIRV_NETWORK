...
impl HRMCognitive {
    ...
    pub fn new() -> HRMCognitive {
        ...
        HRMCognitive {
            // Model weights are loaded explicitly by the host. Reserving the
            // advertised 562M parameters here would allocate over 2 GiB and
            // make the artifact unusable in browser and edge runtimes.
            weights: Vec::new(),
            l_modules: Vec::new(),
            h_modules: Vec::new(),
            personality_adapter: PersonalityAdapter {
