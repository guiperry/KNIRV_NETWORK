  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-800/20 to-sky-500/20 animate-pulse"></div>
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(30,58,138,0.18),transparent_50%)]"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center space-y-8 max-w-md mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 w-32 h-32 border-4 border-blue-600/30 rounded-2xl animate-pulse"></div>
          <div className="absolute inset-0 w-32 h-32 border-4 border-transparent border-t-blue-500 rounded-2xl animate-spin"></div>
        </div>

        {/* App title */}
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-2">KNIRVENGINE</h1>
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center space-x-2">
            <div className="w-6 h-6 border-2 border-blue-600/30 border-t-blue-500 rounded-full animate-spin"></div>
          ...
          {progress !== null && (
            <div className="w-64 bg-slate-700 rounded-full h-2">
              <div 
                className="bg-gradient-to-r from-blue-700 to-sky-500 h-2 rounded-full transition-all duration-500 ease-out"
          ...
          <div className="flex justify-center space-x-2 mt-6">
            ...
            <div className="w-2 h-2 bg-blue-500/50 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-700 to-sky-500 opacity-50">
