...
func ParseFlags() *Config {
	...
	flag.BoolVar(&config.SingleBatch, "single-batch", config.SingleBatch, "Process a single batch (one workflow iteration) then exit, instead of looping continuously")
