...
# Data Mapper Production Workflow Runner
...
show_usage() {
    echo "Data Mapper Production Workflow Runner"
...
print_header "🚀 Data Mapper Production Workflow"
echo "======================================="
...
cd "$PROJECT_ROOT"
go build -o data-mapper ./cmd/data-mapper
