# Data Mapper - Document Structuring Engine
...
3. **Usage**:
    ...
    **🚀 Integrated Workflow (Recommended)**:
    ...
    ./data-mapper -arxiv-enable -arxiv-categories "cs.AI,cs.LG" -arxiv-max-papers 50
    ```
...
The Data Mapper now includes a hybrid embeddings system that combines **Cloudflare Workers AI** embeddings with **local Ollama** embeddings for optimal performance and reliability.
...
CLOUDFLARE_DAILY_LIMIT=1000 ./data-mapper -input ./documents
```
...
## Integration with Data Mapper Ecosystem

This tool is designed to work seamlessly with the broader Data Mapper architecture:
