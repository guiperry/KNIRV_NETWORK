...
- Created `GetAppDataDir()` function that returns OS-specific data directories:
  - Windows: `%APPDATA%/data-mapper`
  - macOS: `~/Library/Application Support/data-mapper`
  - Linux/Unix: `~/.local/share/data-mapper` (following XDG Base Directory Specification)
