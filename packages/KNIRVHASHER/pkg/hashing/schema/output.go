...
// This definition is shared across pipeline stages (2_DATA_ENCODER, 4_DATA_TRAINER, etc.)
// to prevent drift between independently-maintained struct copies.
type TrainingFrame struct {
	...
	WindowStart   int32   `json:"window_start" parquet:"name=window_start, type=INT32"`
	WindowEnd     int32   `json:"window_end" parquet:"name=window_end, type=INT32"`
	ContextLength int32   `json:"context_length" parquet:"name=context_length, type=INT32"`
