# KNIRV Client API Documentation
...
The KNIRV Client API provides comprehensive endpoints for code scanning, security analysis, project management, and AI-powered remediation. All services are consolidated on **port 3000** for simplified deployment.
...
Returns the health status of the KNIRV Client service.
...
Returns current KNIRV Client configuration settings.
...
Updates KNIRV Client configuration settings.
...
Creates a backup of the KNIRV Client database.
...
{
  "success": true,
  "backup_path": "/path/to/backup/knirvclient-backup-20240115-103000.db",
  "timestamp": "2024-01-15T10:30:00Z",
  "encrypted": true,
  "size_bytes": 10485760,
  "collections": [
...
```json
{
  "backups": [
    {
      "filename": "knirvclient-backup-20240115-103000.db",
      "path": "/path/to/backup/knirvclient-backup-20240115-103000.db",
      "size": 10485760,
...
- **Email:** support@knirvclient.dev
- **GitHub Issues:** https://github.com/guiperry/knirvclient/issues
- **Documentation:** https://github.com/guiperry/knirvclient/wiki
