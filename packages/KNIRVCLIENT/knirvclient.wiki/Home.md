# Welcome to the KNIRV Client Wiki!

KNIRV Client is an AI-powered code guardian designed to provide deep visibility into your software architecture, proactively detect risks, and automatically remediate issues. It acts as a continuous, autonomous security and quality engineer for your codebase.

## What is KNIRV Client?

At its core, KNIRV Client is a sophisticated Go application that performs a multi-faceted analysis of a software project. It combines:
...
The scanner is the heart of KNIRV Client. It performs a multi-phase scan to build a complete picture of your project:
...
KNIRV Client doesn't just find simple anti-patterns. It uses a powerful, multi-provider AI Inference Engine (supporting models from Gemini, Anthropic, Cerebras, and more) to:
...
- **Creates a Git Branch**: Isolates all automated changes in a new branch (e.g., `knirvclient-fixes-YYYYMMDD-HHMMSS`).
...
KNIRV Client is highly configurable:
