...
A Python client for sending logs to KNIRVClient's log ingestion API.
...
class KNIRVClientClient:
    ...
    def __init__(self, base_url: str = "http://localhost:3000/api/v1", timeout: int = 10):
        ...
        Args:
            base_url: Base URL of the KNIRVClient API
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="KNIRVClient Log Ingestion Client",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=__doc__
    )

    parser.add_argument('--url', default='http://localhost:3000/api/v1',
                       help='KNIRVClient API base URL')
    ...
    # Create client
    client = KNIRVClientClient(args.url)
