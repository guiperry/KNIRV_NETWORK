...
// Enhanced handlers that integrate with KNIRVClient when available

// handleKnowledgeGraphWithGuardian returns knowledge graph data from KNIRVClient
//
//nolint:unused // This function is used internally by enhanced handlers when guardian is available
func handleKnowledgeGraphWithGuardian(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
...
// handleRiskAssessmentWithGuardian returns risk assessment data from KNIRVClient
//
//nolint:unused // This function is used internally by enhanced handlers when guardian is available
func handleRiskAssessmentWithGuardian(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
	w.Header().Set("Content-Type", "application/json")
	w.Header().Set("Access-Control-Allow-Origin", "*")
...
func handleTriggerScan(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
	w.Header().Set("Content-Type", "application/json")
	w.Header().Set("Access-Control-Allow-Origin", "*")

	if guardian == nil || guardian.Guardian == nil {
		http.Error(w, "KNIRV Client not available", http.StatusServiceUnavailable)
		return
	}
...
// handleGuardianStatus returns the current status of KNIRVClient
func handleGuardianStatus(w http.ResponseWriter, _ *http.Request, guardian *KNIRVClient) {
	w.Header().Set("Content-Type", "application/json")
	w.Header().Set("Access-Control-Allow-Origin", "*")
...
// Enhanced dashboard data endpoints with KNIRVClient integration
func handleEnhancedKnowledgeGraph(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
...
func handleEnhancedRiskAssessment(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
...
func handleEnhancedIssues(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
...
func handleEnhancedCoverage(w http.ResponseWriter, r *http.Request, _ *KNIRVClient) {
	// Enhanced coverage handler with detailed metrics
	log.Printf("📊 Enhanced coverage request from %s", r.RemoteAddr)

	// This would be called from the main server with access to KNIRVClient
	// For now, just call the basic handler
	handleCoverage(w, r)
}

func handleEnhancedSettings(w http.ResponseWriter, r *http.Request, guardian *KNIRVClient) {
	// The server port is chosen when the process starts. Report the selected
	// value to the dashboard rather than a configured (and possibly unavailable)
	// requested port.
	log.Printf("📊 Enhanced settings request from %s", r.RemoteAddr)
	if guardian != nil && guardian.Config != nil {
		w.Header().Set("Content-Type", "application/json")
		json.NewEncoder(w).Encode(map[string]int{"server_port": guardian.Config.ServerPort})
		return
	}
...
func handleEnhancedScanHistory(w http.ResponseWriter, r *http.Request, _ *KNIRVClient) {
...
func handleEnhancedSemanticSearch(w http.ResponseWriter, r *http.Request, _ *KNIRVClient) {
...
func handleEnhancedSystemMetrics(w http.ResponseWriter, r *http.Request, _ *KNIRVClient) {
...
func handleEnhancedAPIDocs(w http.ResponseWriter, r *http.Request, _ *KNIRVClient) {
