...
// TestNewKNIRVClient tests the KNIRVClient constructor
func TestNewKNIRVClient(t *testing.T) {
...
`
	...
	guardian := NewKNIRVClient(cfg, nil, mockChromem)
...
func TestAIRemediationWorkflow(t *testing.T) {
	...
	guardian := NewKNIRVClient(cfg, nil, nil)
...
func TestConfigurationValidation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.NotPanics(t, func() {
				guardian := NewKNIRVClient(tt.config, nil, nil)
