...
const pricingPlans = [
  {
    ...
    description: "KNIRV Client CLI: The Developer's Command-Line Co-pilot\n\nGet started with KNIRV Client's core analysis and remediation engine, completely free and open-source. Built for developers who live in the terminal, the KNIRV Client CLI brings powerful, AI-driven architectural insights directly into your local development workflow.\n\nAnalyze your repositories, identify security risks, and generate code fixes without your source code ever leaving your machine. It's the perfect tool for individual developers, security researchers, and small teams looking to adopt a security-first mindset from the ground up.",
    features: [
    ...
    button: {
      ...
      href: "https://github.com/guiperry/knirvclient",
      icon: Github
    }
  },
  {
    ...
    description: "KNIRV Client Cloud: Your Architecture Co-pilot, Fully Managed.\n\nMove beyond the command line and bring the full power of KNIRV Client to your entire team with our fully-managed cloud platform. We handle the infrastructure, AI model orchestration, and data visualization, so you can focus exclusively on building secure, robust, and maintainable software.\n\nKNIRV Client Cloud is the definitive solution for development teams, security professionals, and enterprise architects who need deep, collaborative insights and a seamless, \"zero-config\" experience.",
    features: [
      ...
      { title: "Historical Analysis & Trend Reporting", description: "Don't just see a snapshot in time. KNIRV Client Cloud stores historical scan data, allowing you to visualize trends, measure the impact of your refactoring efforts, and prove a reduction in risk over time." },
      { title: "Automated CI/CD Integration", description: "Easily integrate KNIRV Client into your existing CI/CD pipelines with our secure webhooks and GitHub App. Enforce quality gates, block vulnerable dependencies, and get feedback directly in your pull requests." },
...
<script>
  ...
  {
    title: "KNIRV Client Enterprise",
    subtitle: "Contact for Pricing",
    description: "KNIRV Client Enterprise: Mission-Control for Your Software Ecosystem\n\nFor organizations that require the highest level of security, support, and integration, KNIRV Client Enterprise provides a complete, white-glove solution. It includes all the collaborative power of KNIRV Client Cloud, enhanced with dedicated support and enterprise-grade features to ensure your mission-critical applications are secure, compliant, and built to last.\n\nThis plan is designed for large development teams and enterprises that need to enforce architectural standards, manage risk at scale, and receive expert guidance on demand.",
    features: [
      { title: "Everything in KNIRV Client Cloud", description: "" },
