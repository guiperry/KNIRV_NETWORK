        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              KNIRV Client provides comprehensive Go-powered analysis with AI-driven remediation. 
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="border-primary/50 hover:bg-primary/10">
                <a href="https://github.com/guiperry/knirvclient" target="_blank" rel="noopener noreferrer">
