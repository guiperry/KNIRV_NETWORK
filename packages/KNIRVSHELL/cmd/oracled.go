...
submitting governance proposals.`,
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if oracledRPCURL == "" {
			return fmt.Errorf("oracle daemon RPC URL not provided; use --oracled-url or configure knirv.services.knirvoracled.rpc_url")
		}
		return nil
	},
}
...
var statusCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err != nil {
			return fmt.Errorf("failed to get knirv-oracled status: %w", err)
		}
