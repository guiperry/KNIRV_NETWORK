...
type ServicesConfig struct {
	...
	KNIRVServer   ServiceConfig `mapstructure:"knirvserver"`
...
func SaveConfig(config *Config, configFile string) error {
	...
	v.Set("knirv.services.knirvserver.url", config.KNIRV.Services.KNIRVServer.URL)
	v.Set("knirv.services.knirvserver.api_key", config.KNIRV.Services.KNIRVServer.APIKey)
	v.Set("knirv.services.knirvserver.timeout", config.KNIRV.Services.KNIRVServer.Timeout)
	v.Set("knirv.services.knirvserver.retries", config.KNIRV.Services.KNIRVServer.Retries)
	v.Set("knirv.services.knirvserver.enabled", config.KNIRV.Services.KNIRVServer.Enabled)
