...
export default function Badges() {
  ...
  const totalNrnCost = badges.filter(badge => badge.isActive).reduce((sum, badge) => sum + badge.nrnCost, 0);
      ...
      <div className="p-4 pb-24 space-y-6">
        ...
        <div className="text-center py-4">
          ...
          <p className="text-slate-400 text-sm font-mono uppercase tracking-wider">
            Manage and configure your KNIRV badge inventory
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="glass-panel p-4 text-center glow-hover">
            <div className="text-2xl font-bold text-white">{activeBadges}</div>
            <div className="text-xs text-slate-500 font-mono uppercase tracking-wider">Active Badges</div>
          </div>
          <div className="glass-panel p-4 text-center glow-hover">
        ...
        <div className="relative group">
          ...
          <div className="relative glass-panel p-6 glow-hover text-center">
            <h3 className="text-lg font-semibold text-white mb-2">Discover New Badges</h3>
            <p className="text-sm text-slate-400 mb-4">
              Browse the KNIRV marketplace for cutting-edge capability badges
            </p>
