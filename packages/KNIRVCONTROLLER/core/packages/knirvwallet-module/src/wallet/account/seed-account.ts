...
import { publicKeyToAddress, publicKeyToOracleAddress } from '../../utils/address';
import { isHDWalletKeyring, Keyring, KeyringType } from '../keyring';
...
export class SeedAccount implements Account {
  ...
  public async getOracleAddress() {
    return publicKeyToOracleAddress(this.publicKey);
  }
  public toData() {
    return {
      id: this.id,
