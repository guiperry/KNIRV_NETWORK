...
/**
 * Type-safe address validation implementation
 * Replaces knirvwallet-module's validateAddress function
 */
export function validateAddress(address: string): boolean {
  ...
  try {
    // Bech32 addresses should have format: prefix1data
    ...
    // Prefix should be 1-16 characters, lowercase letters and numbers only
    ...
    // Data should be 32-90 characters (for typical blockchain addresses)
    ...
    if (!validChars.test(data.toLowerCase())) {
      return false;
    }
