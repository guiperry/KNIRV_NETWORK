            ...
            <Card className="knirv-card-gradient backdrop-blur-lg">
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#quick-start" className="text-blue-400 hover:text-blue-300 flex items-center">
            ...
            <Card className="knirv-card-gradient backdrop-blur-lg">
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#deployment" className="text-blue-400 hover:text-blue-300 flex items-center">
                    Read Guide <ExternalLink className="h-4 w-4 ml-1" />
                  </Link>
                </div>
              </CardContent>
