        ...
        <div className="h-16 border-b border-blue-600/30 bg-slate-900/80 backdrop-blur-sm p-4 flex items-center justify-between z-50">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-2">
              ...
              <Badge
                variant="outline"
                className={`${securitySubsystem.backend === 'native' ? 'bg-amber-500/10 text-amber-400 border-amber-500/20' : 'bg-cyan-500/10 text-cyan-400 border-cyan-500/20'} text-[9px]`}
              >
                KERNEL: {getSecurityBackendLabel(securitySubsystem).toUpperCase()}
              </Badge>
            ...
            <div className="max-w-3xl w-full space-y-8 text-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-xl mx-auto">
                  ...
                  All interactions are monitored by {getSecurityBackendLabel(securitySubsystem)} high-stakes validation guardrails.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800 text-left space-y-2">
                  <div className="flex items-center space-x-2 text-cyan-400">
                    <Shield className="w-4 h-4" />
                    <span className="text-xs font-bold uppercase">Isolation</span>
                  </div>
                  <p className="text-lg font-mono text-slate-200">{securitySubsystem.isolator?.active_containers ?? 0} active</p>
                </div>
              </div>
