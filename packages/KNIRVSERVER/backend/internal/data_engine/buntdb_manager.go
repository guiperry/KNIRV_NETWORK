...
// NOTE: UserEntry has been deprecated and removed.
// Use backend_server/internal/objects.User with backend_server/internal/services/auth.UserService instead.
...
// NOTE: User Management Methods have been deprecated and removed.
// Use backend_server/internal/services/auth.UserService instead for all user management operations:
// - CreateUser -> UserService.CreateUser
// - GetUser -> UserService.GetUserByID
// - GetUserByUsername -> UserService.GetUserByUsername
// - UpdateUser -> UserService.UpdateUser
// - ListUsers -> (implement in UserService if needed)
//
// This eliminates redundant business logic and consolidates authentication to a single authoritative source.
