...
Note: For privileged tests (cgroups, namespaces), use the test-server-privileged.sh script instead.
...
EOF
    ...
    echo "See [coverage.html](../backend_server/coverage/coverage.html) for detailed coverage report." >> "$report_file"
