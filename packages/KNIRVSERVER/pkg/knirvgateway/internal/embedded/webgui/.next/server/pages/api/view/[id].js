"use strict";(()=>{var e={};e.id=8092,e.ids=[8092],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,o){return o in t?t[o]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,o)):"function"==typeof t&&"default"===o?t:void 0}}})},4026:(e,t,o)=>{o.r(t),o.d(t,{config:()=>d,default:()=>l,routeModule:()=>c});var i={};o.r(i),o.d(i,{default:()=>s});var a=o(1802),n=o(7153),r=o(6249);async function s(e,t){if("GET"!==e.method)return t.setHeader("Allow",["GET"]),t.status(405).json({message:"Method Not Allowed"});let{id:o}=e.query;if(!o||"string"!=typeof o)return t.status(400).json({message:"Invalid or missing object ID"});try{let e=await fetch(`http://localhost:3001/api/objects/${o}`,{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok){let i=await e.text();if(console.error(`Backend server error fetching object ${o}: ${e.status} ${e.statusText}`,i),404===e.status)return t.status(404).json({message:`Object with ID "${o}" not found.`});return t.status(e.status<500?e.status:502).json({message:`Failed to fetch object ${o} from backend: ${e.statusText}`})}let i=await e.json();console.log("Object data from backend:",i);let a="/assets/models/cube.gltf";i&&i.file_path&&(a=i.file_path),console.log("Using model URL:",a);let n=`
      <!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>KNIRVCHAIN - ${i.name||"Object"}</title>
      ...
      <body>
        ...
        <div class="ui-container">
          <div class="header">
            <div class="logo">
              <h1>KNIRVCHAIN</h1>
              <span class="object-title">${i.name||"Object"}</span>
              <span class="object-id">ID: ${o}</span>
            </div>
            <div class="controls">
          ...
          <div class="info-panel hidden" id="info-panel">
            <div class="panel-header">
              ...
              <button class="close-button" id="close-info">\xd7</button>
            </div>
            <div class="info-content">
              <div class="info-row">
                <div class="info-label">Name:</div>
                <div class="info-value">${i.name||"Unknown"}</div>
              </div>
              <div class="info-row">
              ...
              <div class="info-row">
                ...
                <div class="info-value">${i.object_type||i.asset_type||"Unknown"}</div>
              </div>
              <div class="info-row">
                <div class="info-label">Author:</div>
                <div class="info-value">${i.data?.author||"Unknown"}</div>
              </div>
              <div class="info-row">
                <div class="info-label">Created:</div>
                <div class="info-value">${i.created_at?new Date(i.created_at).toLocaleString():"Unknown"}</div>
              </div>
              <div class="info-row">
                <div class="info-label">License:</div>
                <div class="info-value">${i.data?.license||"Unknown"}</div>
              </div>
            </div>
          </div>
          ...
          <div class="chain-info">
            ...
            <div class="chain-data">
              <div class="chain-row">
                ...
                <div class="chain-value">${i.transaction?i.transaction.substring(0,10)+"...":"Unknown"}</div>
              </div>
              <div class="chain-row">
                <div class="chain-label">Block:</div>
                <div class="chain-value">#${Math.floor(1e3*Math.random())}</div>
              </div>
              <div class="chain-row">
    ...
    `;return t.setHeader("Content-Type","text/html"),t.status(200).send(n)}catch(i){console.error(`Error fetching object ${o} via Next.js API route:`,i);let e=i instanceof Error?i.message:"Unknown error occurred";return t.status(500).json({message:`Failed to process request for object ${o}: ${e}`})}}let l=(0,r.l)(i,"default"),d=(0,r.l)(i,"config"),c=new a.PagesAPIRouteModule({definition:{kind:n.x.PAGES_API,page:"/api/view/[id]",pathname:"/api/view/[id]",bundlePath:"",filename:""},userland:i})},7153:(e,t)=>{var o;Object.defineProperty(t,"x",{enumerable:!0,get:function(){return o}}),function(e){e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE"}(o||(o={}))},1802:(e,t,o)=>{e.exports=o(145)}};var t=require("../../../webpack-api-runtime.js");t.C(e);var o=t(t.s=4026);module.exports=o})();