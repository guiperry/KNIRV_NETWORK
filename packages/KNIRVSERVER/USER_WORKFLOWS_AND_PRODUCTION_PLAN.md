...
- [ ] **Remove testnet hardcoded tokens** — `renderer.js` and `login/page.tsx` contain `TESTNET_ADMIN_TOKEN`, `TESTNET_VALIDATOR_TOKEN`, `TESTNET_OBSERVER_TOKEN`. These must be removed or gated behind a build flag that is disabled in production builds.
...
- New Go template directory: `backend_server/templates/dve/`
...
| DVE Object | `packages/KNIRVSERVER/backend_server/internal/objects/dve.go` | Add InstallComplete fields |
| Installer | `packages/KNIRVSERVER/backend_server/pkg/knirvchain/manager.go` | Reuse Manager pattern |
| Validation Chain | `packages/KNIRVSERVER/backend_server/internal/services/blockchain/validationchain/client.go` | Add DVE URI methods |
| Viewport Proxy | `packages/KNIRVSERVER/backend_server/internal/runtime/viewport_proxy.go` | Reuse ReverseProxy pattern |
...
- `packages/KNIRVSERVER/backend_server/internal/objects/dve.go` — Add InstallComplete fields
- `packages/KNIRVSERVER/backend_server/internal/services/blockchain/validationchain/client.go` — Add DVE URI methods
- `packages/KNIRVSERVER/backend_server/internal/web/api_router.go` — Register DVE proxy routes
...
- `packages/KNIRVSERVER/backend_server/internal/services/installer/installer.go` — Installer service
- `packages/KNIRVSERVER/backend_server/internal/services/dve_uri_registry.go` — DVE URI registry
- `packages/KNIRVSERVER/backend_server/internal/web/dve_proxy_handlers.go` — DVE proxy handlers
- `packages/KNIRVSERVER/backend_server/templates/dve/*.gohtml` — Public DVE templates
