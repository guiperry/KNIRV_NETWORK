...
impl DistributedCollection {
    ...
    pub async fn insert(&self, _ctx: &str, doc: HashMap<String, serde_json::Value>) -> Result<HashMap<String, serde_json::Value>, Box<dyn std::error::Error + Send + Sync>> {
        // Add CRDT metadata
