...
export declare function encrypt(kp: PQCKeyPair, plaintext: Uint8Array): Uint8Array;
export declare function decrypt(kp: PQCKeyPair, ciphertext: Uint8Array): Uint8Array;
export declare function sign(kp: PQCKeyPair, message: Uint8Array): Uint8Array;
export declare function verify(kp: PQCKeyPair, message: Uint8Array, signature: Uint8Array): boolean;
