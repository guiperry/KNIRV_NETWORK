import { createMemoryEncryption, defaultMemoryEncryption, encryptWithPassword, decryptWithPassword } from '../index';
describe('Security Index', () => {
    ...
    describe('quick helpers', () => {
        ...
        it('should fail to decrypt with wrong password', async () => {
            ...
            await expect(decryptWithPassword(encryptedData, salt, wrongPassword)).rejects.toThrow();
        });
    });
});
