...
describe('Logger', () => {
  ...
  describe('context methods', () => {
    it('should create logger with block ID context', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringMatching(/.*"block_id":"test-block-123".*/)
      );
    });
    ...
    it('should create logger with user ID context', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringMatching(/.*"user_id":"user-456".*/)
      );
    });
    ...
    it('should create logger with custom context', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringMatching(/.*"custom_field":"custom_value".*/)
      );
      expect(console.log).toHaveBeenCalledWith(
        expect.stringMatching(/.*"number_field":42.*/)
      );
    });
  });
