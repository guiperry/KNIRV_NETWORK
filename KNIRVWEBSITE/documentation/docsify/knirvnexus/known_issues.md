...
**Source**: KNIRVNEXUS/docs/known_issues.md

# Known Issues and Troubleshooting Guide

This document provides a comprehensive list of known issues that you might encounter while using the Agentic Engine, along with detailed troubleshooting steps to resolve them.
...
2. Check if the plugin is compatible with your version of Agentic Engine
...
3. If using a downloaded binary, remove quarantine attributes:
   ```bash
   xattr -d com.apple.quarantine ./agentic-engine
   ```
...
The Agentic Engine includes an AI-powered error analysis system that can help diagnose and fix issues automatically. When you encounter an error:
