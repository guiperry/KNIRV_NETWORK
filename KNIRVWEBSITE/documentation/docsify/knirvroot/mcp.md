...
**Source**: KNIRVROOT/documentation/docsify/core-concepts/mcp.md
...
*   **ContextRecord Created:**
    ...
    *   `Initiator`: AgentX's KNIRVROOT address.
...
*   **ContextRecord Created:**
    ...
    *   `Initiator`: The user's (or application's service) KNIRVROOT address.
    *   `Timestamp`: Current time.
...
*   **ContextRecord Created:**
    ...
    *   `Initiator`: The agent Client's KNIRVROOT address.
    *   `Timestamp`: Current time.
...
*   **ContextRecord Created:**
    ...
    *   `Initiator`: HelperBot's KNIRVROOT address.
    *   `Timestamp`: Current time.
...
*   **ContextRecord Created (for `SAMPLING_REQUEST_SENT`):**
    ...
    *   `Initiator`: The MCP server's KNIRVROOT address.
    *   `Timestamp`: Current time.
...
*   **Scenario:** You want to see a chronological log of all new capabilities (Tools, Plugins, etc.) registered on the KNIRVROOT network.
