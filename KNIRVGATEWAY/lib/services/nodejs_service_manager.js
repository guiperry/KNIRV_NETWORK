/**
 * KNIRVGATEWAY Node.js Service Manager
 * 
    ...
    this.config = {
      ...
      services: {
        paymentGateway: {
          ...
          scriptPath: config.paymentGateway?.scriptPath || 'services/payment-gateway/server.js'
        },
        tunnelRegistry: {
      ...
      nodeId: config.nodeId || 'knirvgateway-node',
      ...config
    };
