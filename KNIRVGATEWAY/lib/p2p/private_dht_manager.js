/**
 * Private DHT Manager for KNIRVGATEWAY
 * 
...
const PRIVATE_DHT_CONFIG = {
  ...
  SERVICE_NAMESPACE: 'knirvgateway',
...
class PrivateDHTManager extends EventEmitter {
  constructor(chainID = 'testnet', serviceID = 'knirvgateway', options = {}) {
    super();
    ...
    this.serviceAnnouncement = {
      ...
      timestamp: Date.now(),
      capabilities: options.capabilities || ['gateway', 'bootstrap'],
      version: '1.0.0'
    };
  }
  ...
  async discoverServices() {
    ...
    try {
      ...
      const serviceTypes = ['knirvgateway', 'knirvgraph', 'knirvchain', 'knirvnexus', 'knirvrouter', 'knirvoracle'];
