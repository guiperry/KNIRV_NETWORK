...
**Source**: KNIRVNEXUS/agentify/agent_inferencer_usage.md
...
```go
import "github.com/cloud-equities/KNIRVCHAIN/inference/agentify"
```
...
import (
    ...
    "github.com/cloud-equities/KNIRVCHAIN/inference/agentify"
)
