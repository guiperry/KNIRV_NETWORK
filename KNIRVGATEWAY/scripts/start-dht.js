...
/**
 * KNIRVGATEWAY DHT Startup Script
 * 
 * Initializes and starts the DHT service for network monitoring.
 * Can be run standalone or integrated with the main KNIRVGATEWAY startup.
 */
...
class DHTStarter {
  ...
  async initialize() {
    try {
      console.log('Initializing KNIRVGATEWAY DHT Service...');
  ...
  async start() {
    ...
    try {
      console.log('Starting KNIRVGATEWAY DHT Service...');
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      console.log('KNIRVGATEWAY DHT Starter');
      console.log('Usage:');
