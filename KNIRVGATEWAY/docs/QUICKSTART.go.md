# Quick Start Guide - KNIRVGATEWAY Go Version
...
Build complete: bin/knirvgateway
```
...
Expected output:
```
{"level":"info","msg":"KNIRVGATEWAY starting","mode":"persistent","port":8080,"chainID":"testnet"}
...
That's it! You now have a fully functional KNIRVGATEWAY running in Go! 🚀
