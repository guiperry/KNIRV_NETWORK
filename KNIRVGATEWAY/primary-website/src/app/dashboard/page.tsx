      ...
      <div className="space-y-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 bg-white/5 border border-white/10">
            <TabsTrigger value="dashboard" className="data-[state=active]:bg-knirv-primary/20">
              Dashboard
            </TabsTrigger>
            <TabsTrigger value="compile" className="data-[state=active]:bg-knirv-primary/20">
              <Code className="w-4 h-4 mr-2" />
              Compile
            </TabsTrigger>
            <TabsTrigger value="test" className="data-[state=active]:bg-knirv-primary/20">
              Test Runner
            </TabsTrigger>
            <TabsTrigger value="deploy" className="data-[state=active]:bg-knirv-primary/20">
        ...
        <div className="flex justify-end mt-6">
          <Button
            className="flex items-center bg-gradient-to-r from-knirv-primary to-knirv-secondary hover:from-knirv-secondary hover:to-knirv-primary text-white"
            variant="outline"
          >
