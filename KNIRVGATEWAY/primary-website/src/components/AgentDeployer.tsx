...
const AgentDeployer = ({
  ...
  const handleLocalDownload = (platform: 'windows' | 'mac' | 'linux') => {
    setSelectedPlatform(platform);
    toast({
      title: "Downloading KNIRV Engine",
      description: `Downloading KNIRV Engine for ${platform} with your compiled agent plugin`,
    });
    onDownload(platform);
  };
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="flex items-center justify-between mb-12">
        <div className="text-center md:text-left w-full">
          <h2 className="text-4xl font-bold text-white mb-4">Deploy Your custom Neural Intellegence Model </h2>
          <p className="text-xl text-white/70">
            Deploy your model for {connectedApp.name} to the cloud or locally
          </p>
        </div>
      </div>
        ...
        <Card className="bg-white/5 border-white/10 backdrop-blur-lg">
          <CardHeader>
            ...
            <CardDescription className="text-white/70">
              Deploy your model to cloud platforms for global access
            </CardDescription>
          </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="bg-white/5 border-white/10 backdrop-blur-lg">
          <CardHeader>
            ...
            <CardDescription className="text-white/70">
              Download and run your model locally on your machine
            </CardDescription>
          </CardHeader>
          <CardContent>
