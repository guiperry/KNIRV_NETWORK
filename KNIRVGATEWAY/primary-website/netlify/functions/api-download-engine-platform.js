...
// Generated: 2025-09-22T04:34:49.539Z
...
async function GET(event, context) {
  ...
  try {
    ...
    try {
      ...
      statusCode: 404,
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({error: `No KNIRV Engine release found for ${platform}`})
    };
      }
      ...
      statusCode: 404,
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({error: `No KNIRV Engine release available for ${platform}`})
    };
    }
