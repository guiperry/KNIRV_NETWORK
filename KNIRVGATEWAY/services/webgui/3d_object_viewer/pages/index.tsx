...
// Client-side only component for 3D object viewer
export default function Main() {
  ...
  const [markdownContent, setMarkdownContent] = useState<string>('# Welcome to KNIRVCHAIN\n\nSelect an object to view its details.');
  ...
  const selectObject = useCallback((object: ObjectType) => {
    setSelectedObject(object);
    logToConsole(`Selected object: ${object.name} (ID: ${object.id})`);
    ...
    if (object.object_type === 'markdown') {
      ...
      setMarkdownContent(`# ${object.name}\n\nThis is a markdown document for object ID: ${object.id}`);
    }
  }, [logToConsole]);
  ...
  const handleUpload = async () => {
    ...
    setTimeout(() => {
      logToConsole(`Creating transaction for object: ${uploadName}`);
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          logToConsole(`Object ${uploadName} added to the chain`);
  ...
  return (
    <div className="container">
      <div className="header">
        <div className="logo">
          <h1>KNIRVCHAIN</h1>
          <span className="subtitle">3D Object Blockchain Viewer</span>
        </div>
            ...
            <div className="object-list">
              ...
              <div className="objects-container">
                {objects.length > 0 ? (
                  ...
                  <div className="empty-state">No objects available</div>
                )}
              </div>
            </div>
          )}
          ...
          <div className="viewport-container">
            ...
            <div className="viewport">
              {selectedObject ? (
                ...
                <div className="placeholder">Select an object to view</div>
              )}
            </div>
          </div>
