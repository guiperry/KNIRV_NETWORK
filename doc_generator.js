...
const CONFIG = {
  ...
  outputDir: path.join(__dirname, 'KNIRVWEBSITE', 'documentation'),
  docsifyDir: path.join(__dirname, 'KNIRVWEBSITE', 'documentation', 'docsify'),
  hashFile: path.join(__dirname, 'KNIRVWEBSITE', 'documentation', '.doc_hashes.json'),
