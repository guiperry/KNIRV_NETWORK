...
func getMasterWallet(db *LevelDB, role config.Role) (*Wallet, error) {
	...
	masterWalletData, err := db.GetBytes(utils.MASTER_WALLET_KEY)
	...
	if err := db.PutBytes(utils.MASTER_WALLET_KEY, walletData); err != nil {
