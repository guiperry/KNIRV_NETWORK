...
**KNIRVWALLET** is a powerful, open-source, non-custodial wallet designed as the seamless gateway to the KNIRV Decentralized Trusted Execution Network (D-TEN). KNIRVWALLET enables users to manage NRN tokens, control KNIRV-SHELL agents, and interact with the entire KNIRV ecosystem through an intuitive, Web2-like experience powered by XION's Meta Accounts.
​
...
​
For developers, KNIRVWALLET provides comprehensive APIs for integrating with the KNIRV ecosystem and KNIRV-SHELL agents!
...
✅ **KNIRV-SHELL Agent Control** - Manage and control your AI agents <br>
...
- [KNIRV-SHELL](../KNIRVSHELL/) - AI agent framework
