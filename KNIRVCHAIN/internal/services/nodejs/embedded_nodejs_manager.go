...
import (
	...
	"KNIRVCHAIN/config"
	"KNIRVCHAIN/internal/embedded/nodejs/operator"
	"KNIRVCHAIN/internal/embedded/nodejs/payment"
	"KNIRVCHAIN/internal/embedded/nodejs/tunnel"
	"KNIRVCHAIN/internal/embedded/nodejs/webgui"
	"KNIRVCHAIN/internal/services/interfaces"
	"KNIRVCHAIN/internal/services/manager"
)
