# KNIRVCHAIN Command Line Interface

This directory contains the main application entry points for KNIRVCHAIN.

## Entry Points

### main.go
The primary entry point for the KNIRVCHAIN application. This is the standard mode that includes all services and functionality.

### main_bootnode.go
Entry point for running KNIRVCHAIN as a bootnode. This mode focuses on P2P discovery and network bootstrapping.

### main_client.go
Entry point for running KNIRVCHAIN in client mode. This mode connects to existing Oracle nodes without providing full Oracle services.

### main_developer.go
Entry point for running KNIRVCHAIN in developer mode. This mode includes additional debugging tools and development features.

### main_root.go
Entry point for running KNIRVCHAIN with root/administrative privileges. This mode includes system-level operations and privileged functionality.
