# KNIRVCHAIN Documentation System

This directory contains the organized documentation for the KNIRVCHAIN project. The documentation is automatically generated from the original docs in the `docs/` directory using the `scripts/organize_docs.js` script.
...
- **Core Concepts**: Fundamental concepts of KNIRVCHAIN including blockchain architecture, MCP, capabilities, and URI scheme
- **Protocols**: Detailed documentation of all protocols used in KNIRVCHAIN
- **API Reference**: Complete reference for all KNIRVCHAIN APIs
- **Components**: Information about the various components in the KNIRVCHAIN ecosystem
- **Guides**: Step-by-step guides for common tasks
- **Troubleshooting**: Solutions to common problems
- **SDK**: Documentation for the KNIRVCHAIN SDK
...
When the KNIRVCHAIN server is running.
