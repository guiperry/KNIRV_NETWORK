    ...
    <div className="container mx-auto max-w-3xl py-12 px-4">
      <Card>
        ...
        <CardContent className="space-y-6 text-foreground/80">
          <p>Your privacy is important to us. It is AgentVerse Registry's policy to respect your privacy regarding any information we may collect from you across our website, [Your Website URL], and other sites we own and operate.</p>
