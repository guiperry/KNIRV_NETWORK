...
echo "🚀 Starting KNIRV-NEXUS unified testnet node with new architecture..."
...
if [ ! -f "./bin/knirvnexus" ]; then
    echo "❌ Error: KNIRV-NEXUS unified binary not found."
...
elif [ -f "../KNIRVNEXUS/config/nexus-testnet.yaml" ]; then
...
# Start unified KNIRV-NEXUS binary with new architecture
echo "🌐 Starting KNIRV-NEXUS unified binary with embedded frontend and backend..."
...
echo "⏳ Waiting for KNIRV-NEXUS to initialize..."
sleep 8
