...
(cd ../KNIRVORACLE && go build -o ../KNIRVTESTNET/bin/knirvoracle .)
print_success "KNIRV-ORACLE built."

print_status "Building KNIRVGRAPH..."
(cd ../KNIRVGRAPH && go build -o ../KNIRVTESTNET/bin/knirvgraph ./cmd/node/main.go)
print_success "KNIRVGRAPH built."

print_status "Building KNIRV-NEXUS..."
(cd ../KNIRVNEXUS && go build -o ../KNIRVTESTNET/bin/knirvnexus .)
print_success "KNIRV-NEXUS built."

print_status "Building KNIRV-ROUTER..."
(cd ../KNIRVROUTER && go build -o ../KNIRVTESTNET/bin/knirvrouter .)
print_success "KNIRV-ROUTER built."

# Build Rust Service
print_status "Building KNIRVCHAIN for x86_64-unknown-linux-gnu..."
(cd ../KNIRVCHAIN && cargo build --target x86_64-unknown-linux-gnu --release && cp target/x86_64-unknown-linux-gnu/release/knirvchain ../KNIRVTESTNET/bin/knirvchain)
