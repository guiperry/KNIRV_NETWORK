...
# Build script for Agentic Engine Desktop Application
# This script builds both the Go backend and Electron frontend

set -e

echo "🚀 Building Agentic Engine Desktop Application..."
...
main() {
    case ${1:-build} in
        ...
        clean)
            ...
            rm -f "$PROJECT_ROOT/agentic-engine"
            rm -f "$PROJECT_ROOT/agentic-engine.exe"
