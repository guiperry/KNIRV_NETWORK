#!/bin/bash
# Cross-compilation script for Agentic Engine
# This script builds binaries for Windows, macOS, and Linux platforms

set -e  # Exit immediately if a command exits with a non-zero status

# Configuration variables
# Use BINARY_NAME from environment variable if set, otherwise default to agentic-engine
BINARY_NAME=${BINARY_NAME:-agentic-engine}
...
echo ""
echo "Agentic Engine cross-compilation completed!"
