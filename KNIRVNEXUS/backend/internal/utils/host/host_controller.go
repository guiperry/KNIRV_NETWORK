...
func (hc *HostController) Start() error {
	...
	log.Println("Starting KNIRV-NEXUS Host Controller...")
	...
	log.Println("KNIRV-NEXUS Host Controller started successfully")
	return nil
}
...
func (hc *HostController) Stop() error {
	...
	log.Println("Stopping KNIRV-NEXUS Host Controller...")
	...
	log.Println("KNIRV-NEXUS Host Controller stopped successfully")
	return nil
}
