...
type User struct {
	...
	PasswordHash      string    `json:"-" buntdb:"password_hash"` // Never serialize in JSON
	Salt              string    `json:"-" buntdb:"salt"`
	...
	EmailVerificationToken string `json:"-" buntdb:"email_verification_token"`
	PasswordResetToken string   `json:"-" buntdb:"password_reset_token"`
	PasswordResetExpires *time.Time `json:"-" buntdb:"password_reset_expires"`
	...
	LoginAttempts     int       `json:"-" buntdb:"login_attempts"`
	LockedUntil       *time.Time `json:"-" buntdb:"locked_until"`
	...
	TwoFactorSecret   string `json:"-" buntdb:"two_factor_secret"`
