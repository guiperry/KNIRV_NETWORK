...
// Following Linux standards: ~/.local/share/knirvnexus/os-builder/os-builder
func getAppDataDirectory() (string, error) {
	...
	// Use ~/.local/share/knirvnexus/os-builder/os-builder (XDG Base Directory Specification)
