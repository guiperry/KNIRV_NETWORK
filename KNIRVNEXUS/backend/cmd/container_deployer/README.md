# KNIRV-NEXUS Container Deployer

The **container_deployer** is a specialized Go-based orchestration tool that deploys KNIRV-NEXUS applications in containerized environments using Kata Containers with custom Kali Linux kernels and rootfs images.
...
├── artifacts/
│   └── golang-app-source/    # KNIRV-NEXUS application binary
└── resources/
    ├── ansible/
...
Menu structure:
```
KNIRV-NEXUS Container Deployment
════════════════════════════════
...
2. **Build phase**:
   - Build container image with KNIRV-NEXUS binary
...
│   └── knirv-nexus                 # Main application binary
│
...
**Error**: `exec /app/knirv-nexus: permission denied`
...
```bash
# Check permissions
ls -l ~/.local/share/knirvnexus/container_deployer/artifacts/golang-app-source/knirv-nexus

# Fix permissions
chmod +x ~/.local/share/knirvnexus/container_deployer/artifacts/golang-app-source/knirv-nexus
```
...
# - Configuration errors in knirv-nexus
```
