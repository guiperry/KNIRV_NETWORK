...
import { X, Shield, MapPin, Activity, Clock, Terminal, CheckCircle, Zap, Info, Database, Cpu } from 'lucide-react';
...
const MetadataPanel: React.FC<MetadataPanelProps> = ({ isOpen, onClose, node, isMonitorOpen }) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        width: isMonitorOpen ? '600px' : '650px',
