...
const APITokens = () => {
  ...
  // Auto-login with admin credentials if not authenticated
  useEffect(() => {
    const attemptAutoLogin = async () => {
      if (!isAuthenticated && !autoLoginAttempted) {
        setAutoLoginAttempted(true);
        console.log('Attempting auto-login for API tokens...');
        ...
        try {
          ...
          if (result.success) {
            ...
            // fetchTokens will be called by the next useEffect
          } else {
