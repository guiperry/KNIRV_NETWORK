...
class ErrorHandler {
  ...
  private buildInferencePrompt(errorInfo: ErrorInfo): string {
    return `
You are an expert system administrator and developer assistant for the Agentic Engine application. Analyze the following error and provide actionable solutions.
