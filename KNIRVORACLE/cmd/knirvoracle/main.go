...
import (
	...
	"KNIRVORACLE/pkg/dataengine"
	"KNIRVORACLE/pkg/enum/StatusType"
	"KNIRVORACLE/pkg/errors"
	"KNIRVORACLE/pkg/inference"
	"KNIRVORACLE/pkg/inference/agentify"
	"KNIRVORACLE/pkg/protocol"
	...
	"KNIRVORACLE/pkg/services/monitoring"
...
func (njm *NodeJSManager) StopAllServices() {
	// Placeholder
}

func initNodeJSServices(cfg interface{}, discoveryMgr *DiscoveryManager) (*NodeJSManager, error) {
...
func main() {
	...
	log.Printf("***********STARTING KNIRVORACLE***********")
...
func integrateInferenceEngineWithDHT(discoveryMgr *DiscoveryManager, cfg *config.Config) error {
	...
	metricsKey := fmt.Sprintf("/KNIRVORACLE/inference-metrics/%s", nodeID)
