...
// TreasuryService interface for interacting with KNIRVORACLE treasury
...
func (xpg *XIONPaymentGateway) processPayment(payment *PaymentRequest) {
	...
	// Step 3: Mint NRN tokens via KNIRVORACLE treasury
...
// mintNRNTokens mints NRN tokens via KNIRVORACLE treasury
func (xpg *XIONPaymentGateway) mintNRNTokens(payment *PaymentRequest) error {
	...
	// Call KNIRVORACLE treasury service
