...
AXIOS_SOURCE="$KNIRVORACLE_DIR/agent-tunnel-registry/node_modules/axios/dist/node/axios.cjs"
...
PSL_SOURCE="$KNIRVORACLE_DIR/agent-payment-gateway/node_modules/psl/dist/psl.cjs"
