...
1. **`KNIRVORACLE/agent-tunnel-registry/node_modules/axios/dist/node/axios.cjs`**
...
cd KNIRVORACLE/agent-tunnel-registry && npm install
cd ../agent-payment-gateway && npm install
