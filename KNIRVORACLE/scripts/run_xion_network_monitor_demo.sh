...
# This script demonstrates how XION payment oracle integrates with the existing KNIRV Network Monitor
...
show_integration_overview() {
    ...
    echo "   • xion_oracle_uptime_seconds - Service uptime"
    echo ""
...
demonstrate_integration() {
    ...
    local xion_files=(
        "xion_payment_oracle.go:XION Payment Gateway"
...
# HELP xion_oracle_uptime_seconds XION oracle uptime in seconds
# TYPE xion_oracle_uptime_seconds gauge
xion_oracle_uptime_seconds 86400
EOF
...
show_next_steps() {
    ...
    echo ""
    echo -e "${GREEN}✨ The XION payment oracle will appear as a monitored service${NC}"
