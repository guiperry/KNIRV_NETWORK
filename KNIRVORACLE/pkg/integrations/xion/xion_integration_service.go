...
// OracleConfig contains KNIRVORACLE integration settings
...
func (xis *XIONIntegrationService) processPaymentFlow(flow *PaymentFlow) {
	...
	// Step 3: Process treasury minting via KNIRVORACLE
...
// processTreasuryMinting processes NRN minting via KNIRVORACLE treasury
