          ...
          <Accordion type="single" collapsible className="w-full" defaultValue="item-ans-nanda">
            <AccordionItem value="item-ans-nanda">
                ...
                <AccordionContent className="pt-2 space-y-1">
                    <p className="text-sm text-foreground"><Globe className="inline h-4 w-4 mr-1.5 text-muted-foreground"/><strong>Operator DID (NANDA Identifier):</strong> {agent.id}</p>
                    ...
                    {agent.registeredAt && (
                      ...
                      NANDA provides a lightweight, signed pointer (OperatorAddr) including the DID, Facts URL, and TTL. This points to the detailed, cryptographically verifiable OperatorFacts hosted on the Metadata Distribution Tier, structured according to ANS principles. Operator identity and capability attestations are secured via PKI mechanisms, simulated here for demonstration.
                    </p>
                </AccordionContent>
            </AccordionItem>
