...
type ContextRecordProto struct {
	...
	InteractionType InteractionTypeProto   `protobuf:"varint,3,opt,name=interaction_type,json=interactionType,proto3,enum=KNIRVORACLE.InteractionTypeProto" json:"interaction_type,omitempty"`
...
var file_proto_mcp_context_proto_depIdxs = []int32{
	...
	1, // 3: KNIRVORACLE.MCPInvokeCapabilityDataProto.context_record:type_name -> KNIRVORACLE.ContextRecordProto
