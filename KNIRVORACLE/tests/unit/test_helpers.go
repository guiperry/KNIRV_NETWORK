...
import (
	...
	"KNIRVORACLE/pkg/blockchain"
	"KNIRVORACLE/pkg/crypto"
	"KNIRVORACLE/pkg/p2p"
...
type ChromemManager = agent.ChromemManager
type Wallet = agent.Wallet
type Capability = agent.Capability
type AgentRelationship = agent.AgentRelationship
type FailoverManager = agent.FailoverManager
type WalletManager = agent.WalletManager
type NetworkControlMessage = agent.NetworkControlMessage
type NetworkPausePayload = agent.NetworkPausePayload
...
// Failover manager functions
var NewFailoverManager = agent.NewFailoverManager
var SetGlobalFailoverManager = agent.SetGlobalFailoverManager
var HandleFailoverPromotion = agent.HandleFailoverPromotion
var GetGlobalFailoverManager = agent.GetGlobalFailoverManager
...
var NewLevelDB = blockchain.NewLevelDB
