...
import { ClientOptions } from 'knirvchain-transaction-sdk';
...
export { ClientOptions } from 'knirvchain-transaction-sdk';
export { endpoints } from './tools';

// Create server instance
export const server = new McpServer(
  {
    name: 'knirvchain_transaction_sdk_api',
...
export function initMcpServer(params: {
  ...
  const client = new KnirvchainTransactionSDK(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new KnirvchainTransactionSDK({});
