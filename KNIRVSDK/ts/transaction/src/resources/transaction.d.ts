...
export declare class TransactionResource extends APIResource {
    /**
...
export declare namespace TransactionResource {
    export { type Transaction as Transaction, type TransactionSubmitResponse as TransactionSubmitResponse, type TransactionSubmitParams as TransactionSubmitParams, };
}
