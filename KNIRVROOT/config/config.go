...
type PaymentProcessorConfig struct {
	Enabled               bool    `json:"enabled" mapstructure:"enabled"`
	NodeRPC               string  `json:"node_rpc" mapstructure:"nodeRPC"` // URL of the KNIRVROOT node
...
func DefaultConfig() *Config {
	return &Config{
		NodeName: "KNIRVROOT Node", // Default node name
		...
		DataEngine: DataEngineConfig{
			...
			KafkaClientID:    "KNIRVROOT-client",
			ChromaDBURL:      "http://localhost:8000",
			ChromaCollection: "KNIRVROOT-events",
			EnableKafka:      false,
		...
		Relay: RelayConfig{
			...
			DiscoveryNamespace: "KNIRVROOT-relay",
		},
...
func CreateRootConfigFromMatrixAndConstants() *Config {
	...
	if rootConstants.BlockchainAddress != "" {
		...
		cfg.MinersAddress = ""
		cfg.MasterAddress = ""
		cfg.ChainID = fmt.Sprintf("KNIRVROOT-Faucet%d", cfg.Port)
	}
...
// GetConfigDir returns the base configuration directory (e.g., ~/.config/KNIRVROOT)
...
// - Root: ~/.config/KNIRVROOT/root_data/config.json
// - Bootnode: ~/.config/KNIRVROOT/bootnode_data/config.json
// - Peer: ~/.config/KNIRVROOT/dev_data/config.json
// - Client: ~/.config/KNIRVROOT/client_data/config.json
...
// - Root: ~/.config/KNIRVROOT/root_data
// - Bootnode: ~/.config/KNIRVROOT/bootnode_data
// - Peer: ~/.config/KNIRVROOT/dev_data
// - Client: ~/.config/KNIRVROOT/client_data
...
// - Bootnode: ~/.config/KNIRVROOT/bootnode_data/wallet.dat
// - Peer: ~/.config/KNIRVROOT/dev_data/wallet.dat
// - Client: ~/.config/KNIRVROOT/client_data/wallet.dat
...
// - Bootnode: ~/.config/KNIRVROOT/bootnode_data/master_wallet.dat
// - Peer: ~/.config/KNIRVROOT/dev_data/master_wallet.dat (typically not used)
// - Client: ~/.config/KNIRVROOT/client_data/master_wallet.dat (typically not used)
...
const BLOCKCHAIN_ADDRESS_CONSTANT_FROM_MAIN_OR_CONFIG = "KNIRVROOTb53c1e30b8a578c091dd40612bfd1433991b4e09" // Replace with actual access
...
func DefaultTerminalIntegration() *TerminalIntegration {
	...
	return &TerminalIntegration{
		Enabled:           true,
		ZshCompletionsDir: filepath.Join(homeDir, ".KNIRVROOT", "completions"),
		Theme:             "dark",
	}
}
