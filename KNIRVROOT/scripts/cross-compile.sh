...
# Use BINARY_NAME from environment variable if set, otherwise default to KNIRVROOT
BINARY_NAME=${BINARY_NAME:-KNIRVROOT}
...
EXTERNAL_DIR="/home/gperry/Documents/GitHub/cloud-equities/KNIRVROOT_PUBLIC"
