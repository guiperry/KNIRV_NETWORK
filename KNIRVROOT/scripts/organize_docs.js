/**
 * Documentation Organizer for KNIRVROOT
 * 
...
const STRUCTURE = {
  'index.md': { title: 'KNIRVROOT Documentation', content: '' },
  'getting-started': {
...
async function processReadme() {
  ...
  try {
    ...
    for (const line of lines) {
      ...
      if (line.startsWith('# KNIRVROOT')) {
        continue;
      }
      
      // Include content after the title
      if (line.startsWith('KNIRVROOT is')) {
    ...
    const indexContent = `# KNIRVROOT Documentation\n\n${extractedContent}\n\n## Documentation Sections\n\n`;
    ...
    if (dir !== 'index.md' && typeof content === 'object') {
      ...
      switch (dir) {
        case 'getting-started':
          indexContent += 'This section helps you get up and running with KNIRVROOT quickly.\n\n';
          break;
        case 'core-concepts':
          indexContent += 'Learn about the fundamental concepts that power KNIRVROOT.\n\n';
          break;
        case 'protocols':
          indexContent += 'Detailed documentation of the protocols used in KNIRVROOT.\n\n';
          break;
        case 'api-reference':
          indexContent += 'Complete reference for all KNIRVROOT APIs.\n\n';
          break;
        case 'components':
          indexContent += 'Information about the various components that make up the KNIRVROOT ecosystem.\n\n';
          break;
        case 'guides':
          indexContent += 'Step-by-step guides for common KNIRVROOT tasks.\n\n';
          break;
        case 'troubleshooting':
          indexContent += 'Solutions to common problems and troubleshooting tips.\n\n';
          break;
        case 'sdk':
          indexContent += 'Documentation for the KNIRVROOT SDK.\n\n';
          break;
      }
...
async function createSidebar() {
  ...
  let sidebarContent = '# KNIRVROOT Docs\n\n';
...
<head>
  <meta charset="UTF-8">
  <title>KNIRVROOT Documentation</title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  <meta name="description" content="KNIRVROOT Documentation">
...
<body>
  ...
  <script>
    window.$docsify = {
      name: 'KNIRVROOT',
      repo: 'https://github.com/gperry/KNIRVROOT',
      loadSidebar: true,
      subMaxLevel: 3,
...
async function cleanTargetDirectory() {
  ...
  if (fs.existsSync(sidebarPath)) {
    await writeFile(sidebarPath, '# KNIRVROOT Docs\n\n');
  }
