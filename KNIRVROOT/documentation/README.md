# KNIRVROOT Documentation System

This directory contains the organized documentation for the KNIRVROOT project. The documentation is automatically generated from the original docs in the `docs/` directory using the `scripts/organize_docs.js` script.
...
- **Core Concepts**: Fundamental concepts of KNIRVROOT including blockchain architecture, MCP, capabilities, and URI scheme
- **Protocols**: Detailed documentation of all protocols used in KNIRVROOT
- **API Reference**: Complete reference for all KNIRVROOT APIs
- **Components**: Information about the various components in the KNIRVROOT ecosystem
- **Guides**: Step-by-step guides for common tasks
- **Troubleshooting**: Solutions to common problems
- **SDK**: Documentation for the KNIRVROOT SDK
...
When the KNIRVROOT server is running.
