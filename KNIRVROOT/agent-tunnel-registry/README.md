# KNIRVROOT Tunnel Registry Service

This service provides NAT traversal, node registration, and URI resolution for the KNIRVROOT network.
...
- `RELAY_SERVER_PEER_ID`: PeerID of the KNIRVROOT-ROOT node
