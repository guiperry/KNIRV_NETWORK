  ...
  if (isHtmlRequest) {
    ...
    const html = `
      ...
      <head>
        ...
        <title>KNIRVROOT Bootnode Registry Status</title>
        <style>
          body {
      ...
      <body>
        <h1>KNIRVROOT Bootnode Registry Status</h1>
...
const turnServer = new Turn({
  ...
  //   'agent': Turn.generateLongTermCredentials("KNIRVROOT_secure_password", "agent.com") // Long-term
  // },
  // realm: 'agent.com',
  ...
  software: 'KNIRVROOT Registry TURN/STUN Server',
