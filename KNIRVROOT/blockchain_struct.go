...
func init() {
	...
	// If BLOCKCHAIN_ADDRESS is "KNIRVROOT_Faucet", this is fine for a placeholder.
...
// Account represents a KNIRVROOT account with NRN token balance
type Account struct {
...
func initializeTestAccounts(bc *BlockchainStruct) error {
	...
	testAccounts := map[string]uint64{
		"KNIRVROOT0ad62e0365cf9b2716bb0d7f7ce6226005d4e33d": 10000000, // 10 million units
